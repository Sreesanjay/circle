import{al as F,bm as X,aD as P,b0 as G,am as q,bn as H,an as K,ao as C,bo as J,bp as R,r as b,ap as V,aq as z,j as p,ar as Q,at as Y,aJ as y,bq as Z}from"./index-ViYfmJhI.js";import{c as ee}from"./createBox-uiKRyerh.js";function te(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function ne(t){return parseFloat(t)}const re=F("MuiBox",["root"]),ae=re,ie=X(),oe=ee({themeId:P,defaultTheme:ie,defaultClassName:ae.root,generateClassName:G.generate}),se=oe;function le(t){return q("MuiSkeleton",t)}F("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const ue=["animation","className","component","height","style","variant","width"];let k=t=>t,I,N,L,B;const ce=t=>{const{classes:e,variant:n,animation:r,hasChildren:u,width:f,height:c}=t;return Y({root:["root",n,r,u&&"withChildren",u&&!f&&"fitContent",u&&!c&&"heightAuto"]},le,e)},de=H(I||(I=k`
  0% {
    opacity: 1;
  }
