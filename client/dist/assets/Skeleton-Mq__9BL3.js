import{ak as F,bm as D,aC as P,b0 as G,al as q,bn as H,am as K,an as C,bo as V,bp as R,r as b,ao as z,ap as J,j as p,aq as Q,as as Y,aI as y,bq as Z}from"./index-3YDLuNXw.js";import{c as ee}from"./createBox-4aIxVVay.js";function te(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function ne(t){return parseFloat(t)}const re=F("MuiBox",["root"]),ae=re,ie=D(),oe=ee({themeId:P,defaultTheme:ie,defaultClassName:ae.root,generateClassName:G.generate}),se=oe;function le(t){return q("MuiSkeleton",t)}F("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const ue=["animation","className","component","height","style","variant","width"];let k=t=>t,I,N,L,B;const ce=t=>{const{classes:e,variant:n,animation:r,hasChildren:u,width:f,height:c}=t;return Y({root:["root",n,r,u&&"withChildren",u&&!f&&"fitContent",u&&!c&&"heightAuto"]},le,e)},de=H(I||(I=k`
  0% {
    opacity: 1;
  }
